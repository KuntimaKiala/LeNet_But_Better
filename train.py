...
if __name__ == '__main__' :
    ...
    data_handler = DataHandler(datasets=datasets.FashionMNIST,download=True, shuffle=True, batch_size=512) 
    ...
    trainer = Trainer(model=model, epochs=20, learning_rate=0.8, momentum=0.0)
